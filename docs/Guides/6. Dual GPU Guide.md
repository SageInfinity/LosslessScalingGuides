...
1. Windows 11 has new options in the windows settings. Windows 10 requires registry editing to get games to run on the render GPU and may have unexpected behavior. Read the end of this guide for the steps for windows 10.
...
### Windows 10 - Registry Key for selecting high performance GPU
